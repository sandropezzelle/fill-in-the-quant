...
"""
if args.setting == "1-Sent":
  weights_filename = weights_path+str(mod_name)+'/1-Sent_yes-punct_50word_128hidden_nadam_0.75dropout_04_1.7745_0.3411.hdf5'
else:
    weights_filename = weights_path+str(mod_name)+'/3-Sent_yes-punct_150word_128hidden_adagrad_0.75dropout_12_1.9512_0.2792.hdf5'
...
if __name__ == '__main__':
    ...
    model.add(Bidirectional(LSTM(args.hidden_units)))
