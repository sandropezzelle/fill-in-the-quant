...
"""
if args.setting == "1-Sent":
  weights_filename = weights_path+str(mod_name)+'/1-Sent_yes-punct_50word_128hidden_adam_0.5dropout_08_1.8448_0.3150.hdf5'
else:
    weights_filename = weights_path+str(mod_name)+'/3-Sent_yes-punct_150word_128hidden_adagrad_0.75dropout_20_1.9629_0.2773.hdf5'
...
if __name__ == '__main__':
    ...
    model.add(LSTM(args.hidden_units))
