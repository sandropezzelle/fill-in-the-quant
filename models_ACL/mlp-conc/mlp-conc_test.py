...
"""
if args.setting == "1-Sent":
  weights_filename = weights_path+str(mod_name)+'/1-Sent_yes-punct_50word_512hidden_adagrad_0.5dropout_64batch_01_2.0009_0.2773.hdf5'
else:
    weights_filename = weights_path+str(mod_name)+'/3-Sent_yes-punct_150word_128hidden_adam_0.25dropout_64batch_00_2.0547_0.2242.hdf5'
